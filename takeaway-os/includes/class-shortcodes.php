...
final class TTOS_Shortcodes {
    ...
    public static function assets(): void {
        ...
        wp_enqueue_style('ttos-frontend', TTOS_URL . 'assets/frontend.css', array(), TTOS_VERSION . '-modal-upsells-3');
        wp_enqueue_script('ttos-frontend', TTOS_URL . 'assets/frontend.js', array(), TTOS_VERSION . '-modal-upsells-3', true);
    }
