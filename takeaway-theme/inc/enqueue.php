...
function ttheme_enqueue(): void {
    ...
    $is_home_v2 = is_page_template('page-home-v2.php') || is_page('home-v2');

    if (is_front_page() || $is_home_v2) {
        wp_enqueue_style('takeaway-theme-home', TTHEME_URL . '/assets/css/home.css', array('takeaway-theme-base'), TTHEME_VERSION);
    }
    if ($is_home_v2) {
        wp_enqueue_style('takeaway-theme-home-v2', TTHEME_URL . '/assets/css/home-v2.css', array('takeaway-theme-home'), TTHEME_VERSION);
    }
